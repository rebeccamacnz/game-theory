...
This code will run until all the proposing strategies are the same and all the responding strategies are less than or equal to the corresponding response strategy. For example, if the final proposing strategy is 8 and all the response strategies are either 1 or 2 then the game will stop.

TO RUN
If you have Racket installed on your computer you can run MiniUltimatumGame.rkt but if you don't you can still run the program using the executable file in the zip folder.
